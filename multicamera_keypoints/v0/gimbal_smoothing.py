...
@click.option("--checkpoint_niters", default=500, help="Number of iterations between saving checkpoints")
def main(vid_dir, calib_file, gimbal_params_file, overwrite=False, checkpoint_niters=500):
