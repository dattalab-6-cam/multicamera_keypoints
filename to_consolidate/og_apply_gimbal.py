...
fitted_params = joblib.load(
    "/n/groups/datta/Jonah/20231121_6cam_sniff/kp_detection/gimbal_params.p"
)
...
triangulation_positions = np.load(f"{vid_dir}/robust_triangulation.npy")[
    :, use_bodyparts_ix
][:, node_order]
...
params = generate_gimbal_params(camera_matrices, fitted_params, 1e6, 1, step_size=0.2)
